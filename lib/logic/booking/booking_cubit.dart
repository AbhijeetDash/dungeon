...
/// UI must handle gracefully (friendly message + refresh the grid) rather than
/// as a generic error. It maps to the API's 409.
...
class BookingCubit extends Cubit<BookingState> {
  ...
  Future<void> book({required Venue venue, required Slot slot}) async {
